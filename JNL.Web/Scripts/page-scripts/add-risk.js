    ...
    window.page = {
        ...
        riskIntelligenceConfig: {
            ...
            getAjaxParams: function(input) {
                return {
                    ...
                    Fields: 'Id###Description###TopestName',
                    PageIndex: 1,
                    PageSize: 50,
            ...
            buildDropdownItem: function (data) {
                return '【{0}】{1}'.format(data.TopestName, data.Description);
            },
            afterSelected: function (data, $input) {
                $input.prev().val(data.Id);
            }
        ...
        save: function() {
            if ($('.edit-form').valid()) {
                ...
                // save
                var ajaxUrl = riskInfo.Id > 0 ? '/Common/UpdateData' : '/Common/InsertData';
